...
В каталоге `data` этого репозитория находится структура БД (`ms.sql`) и файлы для импорта: `agents_s_import.csv`, `products_short_s_import.txt`, `productsale_s_import.xlsx`.
