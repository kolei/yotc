...
Перед подключением БД необходимо подключить зависимости *MySql.Data* и *Entity Framework*:

1. Кликаем правой кнопкой мыши по проекту в обозревателе решений и выбираем пункт *Управление пакетами NuGet*

![Управление пакетами NuGet](../img/task033.png)

2. Устанавливаем пакеты *MySql.Data* и *Entity Framework*:

![MySql.Data](../img/task034.png)

![EntityFramework](../img/task035.png)

3. В файл App.config добавляем/редактируем секцию **entityFramework**, добавляя в нее провайдера *MySql.Data.MySqlClient*:
...
1. Снова кликаем правой кнопкой мыши по названию проекта и выбираем пункты *Добавить -> Создать элемент*
...
3. В мастере моделей *создаем соединение*
    ...
    Параметры подключения: Sever name - **192.168.1.53**, User name - **ИФамилия в латинице**, Password - **123456**
